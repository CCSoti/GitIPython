...
The Frey's and Bird's paper \cite{frey2015collection} is investigating the curation of research chemistry data - indication of management \cite{dataCuration}, organization and integration of data, by taking its development during the last ten years and predicting what the information might be like for the next ten years. Frey and Bird \cite{frey2015collection} are reaching the conclusion that technologies of the Semantic Web have improved, they are becoming available and various techniques for the automated computations are being designed frequently. However, there is a continuing for improving the old software tools or creating new ones.\cite{frey2015collection}
