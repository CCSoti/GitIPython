...
% The general problem of using software in science.
% highlight some of the stories e.g. from Bridging the Chasm survey paper.

\subsection{Laboratory Notebooks in Science}
\input{Background/Laboratory_Notebooks/main.tex}

%Previous research on 
% * Paper based lab books in wet laboratories (from Anderson). 
% * Adoption of electronic notebooks in wet labs (not for programming).
